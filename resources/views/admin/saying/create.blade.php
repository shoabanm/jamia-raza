...
<div class="container-fluid px-4">
    <h1 class="mt-4">{{ __('saying.create_title') }}</h1>

    <div class="card mt-4">
        <div class="card-header">{{ __('saying.create_title') }}</div>
        <div class="card-body">
            <form action="{{ route('admin.saying.store') }}" method="POST">
                ...
                <button type="submit" class="btn btn-success mt-4">{{ __('saying.save') }}</button>
            </form>
        </div>
    </div>
</div>
