		  ...
		  <div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
			  <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
				<li class="nav-item">
					<a class="nav-link link text-black display-4" href="{{ route('frontend.digital_libraray') }}">{{ __('frontend.digital_library') }}</a>
				</li>
			
				<li class="nav-item">
				  <a class="nav-link link text-black display-4" href="{{ route('frontend.teachers') }}">{{ __('frontend.teachers') }}</a>
				</li>
			
				<li class="nav-item">
					<a class="nav-link link text-black display-4" href="{{ route('frontend.services') }}">{{ __('frontend.services') }}</a>
				</li>
			  </ul>
